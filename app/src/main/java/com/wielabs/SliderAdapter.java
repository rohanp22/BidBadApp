...
//        this.gradientDrawables.add(new GradientDrawable(GradientDrawable.Orientation.TL_BR, ntiew int[]{Color.parseColor("#b6feff"), Color.parseColor("#5bfeb0"), Color.parseColor("#20ad16")}));
